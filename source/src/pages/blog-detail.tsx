...
const blogContent: Record<string, { title: string; cat: string; date: string; readTime: string; img: string; body: string[] }> = {
  ...
  "tips-glowing-modern": {
    ...
    body: [
      ...
      "Suplemen kecantikan oral seperti S-GLOW dari AIS Beauty adalah solusi modern yang praktis. Cukup konsumsi 1-2 tablet kunyah per hari — bahkan bisa dikonsumsi sebagai camilan sehat — untuk mendapatkan manfaat kolagen dan antioksidan yang optimal.",
