...
export const products: Product[] = [
  ...
  },
  {
    ...
    longDesc: "S-GLOW adalah tablet kunyah kolagen premium dengan cita rasa lemon & peach yang menyegarkan. Diformulasikan oleh iBling dengan formula kolagen berkualitas yang dipadukan dengan ekstrak lemon dan peach untuk membantu menjaga kesehatan dan kecantikan kulit dari dalam secara menyenangkan.",
